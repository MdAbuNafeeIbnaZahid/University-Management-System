 ...
 * @author nafeedgbhs
 */
public class teacherViewAndChangeInfoShowV3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession session = request.getSession();
            String signedInTeacherUsername = (String)session.getAttribute("username");
            
            DataAccess db = new DataAccess();
            Teacher signedInTeacher = db.getTeacherByUsername( signedInTeacherUsername );

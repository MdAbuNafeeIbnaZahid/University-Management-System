 ...
 * @author nafeedgbhs
 */
public class AddNewClassProcess extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String monthOfClass = request.getParameter("monthOfClass");
        String yearOfClass = request.getParameter("yearOfClass");
        ...
        */
        ...
        int count = db.addNewClass(monthOfClass, Integer.parseInt(yearOfClass), 
                departmentName, Integer.parseInt(courseNumber));
